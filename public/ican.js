...
function _getTimeOnsite() {
  _getTimeOnsite = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var rs, cd, x;
...
function _getCode() {
  _getCode = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    var code, rs;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.next = 4;
            return fetch("http://localhost:8000/generate-code", options).then(function (response) {
              return response.json();
            });
