...
>
  ...
  <p class="font-bold mb-3">Tổng số lượng traffic: <span
      id="traffic_sum"
      class="item font-normal traffic_sum"
    ></span>
  </p>
  <p class="font-bold mb-3">Số lượng traffic trong ngày: <span
      class="item font-normal traffic_per_day"
    ></span></p>
  <p class="font-bold mb-3">Time onsite: <span
      class="item font-normal onsite"></span></p>
  <p class="font-bold mb-3">Phải trả (USDT): <span
      id="price"
      class="item font-normal price"
    ></span></p>
  ...
  <div class="flex justify-between items-center">
    ...
    <select
      class="item select max-w-xs priority"
      name="priority"
      id="priority"
      required
    >
  ...
  <div class="flex justify-between items-center">
    ...
    <select
      id="site_types"
      class="item select max-w-xs page_type_id"
      name="page_type"
      required
    >
      <option
  ...
  <div class="flex justify-between items-center mb-3">
    ...
    <input
      type="number"
      class="item input input-bordered hold_percentage"
