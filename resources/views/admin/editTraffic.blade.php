<form id="form" enctype="multipart/form-data" method="POST" class="mb-0">
  ...
  <p class="font-bold mb-3">Phải trả (VND): <span id="price" class="item font-normal price"></span></p>
  ...
  <label class="block">
    ...
    <input type="file" accept="image/*" class="block w-full text-sm text-slate-500
        ...
        hover:file:bg-violet-100" name="image" id="fileUpload">
  </label>
  <div class="flex justify-between items-center">
    <p>
      Chọn mức ưu tiên
    </p>
    <select class="item select max-w-xs priority" name="priority" id="priority" required>
  ...
  <div class="flex justify-between items-center mb-3">
    ...
    <div class="flex items-center">
      <input type="number" id="hour" class="input input-bordered" placeholder="HH" maxlength="2" min="0" max="24">
      <span class="mx-3">:</span>
      <input type="number" id="minute" class="input input-bordered" placeholder="MM" maxlength="2" min="0" max="59">
    </div>
  </div>
  <div class="flex justify-between items-center mb-3">
