        ...
        <table class="table w-full bg-white">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="bg-white">{{$value->price}}</td>
                    <td class="bg-white">
                        <a class="btn btn-success" href="{{url('management/traffic/'.$value->id)}}">Duyệt</a>
                        <form action="{{action('DashboardController@delApproveTraffic', $value->id)}}" method="post">
                            @csrf
                            <button class="btn btn-error">Huỷ</button>
                        </form>
                    </td>
                </tr>
                @endforeach
