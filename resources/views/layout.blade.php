...
<head>
  ...
  <script
    ...
    type="text/javascript"
  ></script>
  <script type="text/javascript" data-src-embed="https://embed.168chat.com/" data-src-js-embed="https://168chat.com/" id="embed-live168" data-id=62f5b31e41ac664b7a09e8ff src="https://168chat.com/embed/template/index.js"></script>
  <meta
    name="csrf-token"
    content="{{ csrf_token() }}"
  />
