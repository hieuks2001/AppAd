    ...
    @else
        <div class="overflow-x-auto bg-white drop-shadow-2xl p-5 rounded-2xl container md:w-2/5 mx-auto">
            <div class="text-slate-800">
                ...
                <p class="mb-3"><b>Bước 2:</b> Tìm kiếm từ khoá <b>>> <span
                ...
                <p class="mb-3"><b>Bước 3:</b> Lướt thật chậm từ trên xuống dưới giống như đang đọc nội dung bài viết rồi
                    ấn vào nút <b>Nhận mã ngay</b> và đợi {{ $page->onsite }}s kết thúc</p>
                <p class="mb-3"><b>Bước 4:</b> Copy mã và nhập vào ô ở phía dưới và bấm vào nút "<b>Hoàn thành nhiệm
