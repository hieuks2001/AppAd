...
@endif
@endif
<div class="container mx-auto select-none overflow-x-auto rounded-2xl bg-white p-5 drop-shadow-2xl md:w-2/3">
  <div id="i">
    <div class="text-slate-800 pb-5">
      <h2 class="mb-5 text-center text-2xl font-bold">Nhiệm vụ của bạn</h2>
      <p class="mb-3">
        <b>Bước 1:</b><b><span style="color: red;"> Mở tab mới bên cạnh</span></b> và truy cập công cụ tìm kiếm:
        <b>>>Google.com</b>
      </p>
      <p class="mb-3">
      ...
      <p class="mb-3"><b>Bước 3:</b> Truy cập vào trang web như hướng dẫn:
        <img class="mx-auto my-3 w-full object-contain" src="https://memtraffic.com/images/{{ $page->image }}"
